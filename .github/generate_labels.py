...
def generate_labels():
    ...
    LABELS = [
        ...
        ("CI/CD",               '#dbca13', "Automation and management of the project itself"),
        ("documentation",       '#006b75', "Update to documentation's content or its generation"),
        ("duplicate",           '#cfd3d7', "This issue or pull request already exists"),
        ("enhancement",         '#84b6eb', "Improvement of an existing feature"),
        ("feature request",     '#fbca04', "Something not existing yet that need to be implemented"),
