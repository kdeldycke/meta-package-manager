...
- [mpm] Link a manager's Wikipedia article from its documentation page, and a declined tool's from its [unsupported](https://mpm.run/unsupported/) verdict. Manager definitions accept a `wikipedia_url` key for it.
