...
- [doc] Drop the unmaintained `pacapt`, `sysget` and `whohas` tools from the benchmark comparison and add a note pointing their users to `mpm` as an actively-maintained replacement covering the same cross-manager operations.
