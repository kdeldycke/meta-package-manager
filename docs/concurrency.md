...
Serialized managers,RPM database,6
...
| RPM database             | [`dnf`](managers/dnf.md), [`dnf5`](managers/dnf5.md), [`microdnf`](managers/microdnf.md), [`urpmi`](managers/urpmi.md), [`yum`](managers/yum.md), [`zypper`](managers/zypper.md)                                                               | they all reach the RPM database, where a second writer either waits for the first one to finish or fails on its lock                                         |
