...
| RPM database             | [`dnf`](managers/dnf.md), [`dnf5`](managers/dnf5.md), [`urpmi`](managers/urpmi.md), [`yum`](managers/yum.md), [`zypper`](managers/zypper.md)                                                                                                   | they all reach the RPM database, and a second writer waits on its lock for as long as the first one holds it, rather than failing                            |
