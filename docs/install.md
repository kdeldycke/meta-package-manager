...
```shell-session
$ uvx meta-package-manager@8.0.0
Installed 21 packages in 42ms
Usage: mpm [OPTIONS] COMMAND [ARGS]...
```
`````
...
```{code-block} shell-session
$ gh attestation verify ./meta-package-manager-7.6.1-macos-arm64.bin --repo kdeldycke/meta-package-manager --signer-repo kdeldycke/repomatic
Loaded digest sha256:... for file://meta-package-manager-7.6.1-macos-arm64.bin
...
```{code-block} shell-session
$ gh attestation verify ./meta_package_manager-7.6.1-py3-none-any.whl --repo kdeldycke/meta-package-manager --signer-repo kdeldycke/repomatic
```
...
Collecting meta-package-manager
  Downloading meta_package_manager-7.6.1-py3-none-any.whl (482 kB)
     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 482.2/482.2 kB 494.7 kB/s eta 0:00:00
(...)
Installing collected packages: (...) meta-package-manager
Successfully installed (...) meta-package-manager-7.6.1
```
...
| `mpm`               | Released   | `3.15` | `3.14` | `3.13` | `3.12` | `3.11` | `3.10` | `3.9` | `3.8` | `3.7` | `3.6` | `3.5` | `3.4` | `3.3` | `2.7` |
| :------------------ | :--------- | :----: | :----: | :----: | :----: | :----: | :----: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `8.0.0`             | 2026-09-20 |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |
| `6.0.x` → `7.6.x`   | 2025-12-08 |   –    |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |
| `5.21.0`            | 2025-05-28 |   –    |   –    |   ✅   |   ✅   |   ✅   |   ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |  ❌   |
