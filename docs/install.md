...
```{code-block} shell-session
$ gh attestation verify ./meta-package-manager-8.0.0-macos-arm64.bin --repo kdeldycke/meta-package-manager --signer-repo kdeldycke/repomatic
Loaded digest sha256:... for file://meta-package-manager-8.0.0-macos-arm64.bin
...
```{code-block} shell-session
$ gh attestation verify ./meta_package_manager-8.0.0-py3-none-any.whl --repo kdeldycke/meta-package-manager --signer-repo kdeldycke/repomatic
```
...
Collecting meta-package-manager
  Downloading meta_package_manager-8.0.0-py3-none-any.whl (827 kB)
     ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 827.2/827.2 kB 494.7 kB/s eta 0:00:00
(...)
Installing collected packages: (...) meta-package-manager
Successfully installed (...) meta-package-manager-8.0.0
```
