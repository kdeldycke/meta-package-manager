# {octicon}`package` Antidote

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("antidote"))
```
...
print(manager_augments("antidote"))
```
...
print(manager_rosetta("antidote"))
```
...
print(manager_operations("antidote"))
```
...
print(manager_selection("antidote"))
```
...
print(manager_recipes("antidote"))
```
...
print(manager_cooldown("antidote"))
```
...
print(manager_version_probe("antidote"))
```
...
print(manager_changelog("antidote"))
```
