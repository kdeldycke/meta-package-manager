# {octicon}`package` Zsh Antigen

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("antigen"))
```
...
print(manager_augments("antigen"))
```
...
print(manager_operations("antigen"))
```
...
print(manager_selection("antigen"))
```
...
print(manager_cooldown("antigen"))
```
...
print(manager_version_probe("antigen"))
```
...
print(manager_upstream("antigen"))
```
...
print(manager_changelog("antigen"))
```
