...
print(manager_operations("deb-get"))
```
...
print(manager_version_probe("deb-get"))
```
...
print(manager_upstream("deb-get"))
```
...
print(manager_changelog("deb-get"))
```
