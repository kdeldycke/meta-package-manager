# {octicon}`package` devkitPro pacman

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("dkp-pacman"))
```
...
print(manager_augments("dkp-pacman"))
```
...
print(manager_rosetta("dkp-pacman"))
```
...
print(manager_operations("dkp-pacman"))
```
...
print(manager_selection("dkp-pacman"))
```
...
print(manager_recipes("dkp-pacman"))
```
...
print(manager_cooldown("dkp-pacman"))
```
...
print(manager_version_probe("dkp-pacman"))
```
...
print(manager_changelog("dkp-pacman"))
```
