# {octicon}`package` dotnet tool

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("dotnet"))
```
...
print(manager_operations("dotnet"))
```
...
print(manager_selection("dotnet"))
```
...
print(manager_version_probe("dotnet"))
```
...
print(manager_changelog("dotnet"))
```
