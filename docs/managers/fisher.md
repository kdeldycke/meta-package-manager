# {octicon}`package` Fish fisher

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("fisher"))
```
...
print(manager_operations("fisher"))
```
...
print(manager_selection("fisher"))
```
...
print(manager_version_probe("fisher"))
```
...
print(manager_changelog("fisher"))
```
