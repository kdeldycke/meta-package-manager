# {octicon}`package` Linux fwupd

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("fwupd"))
```
...
print(manager_operations("fwupd"))
```
...
print(manager_version_probe("fwupd"))
```
