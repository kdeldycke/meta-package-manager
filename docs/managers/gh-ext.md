# {octicon}`package` GitHub CLI extensions
...
print(manager_selection("gh-ext"))
```
...
print(manager_version_probe("gh-ext"))
```
...
print(manager_changelog("gh-ext"))
```
