# {octicon}`package` Haskell ghcup

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("ghcup"))
```
...
print(manager_operations("ghcup"))
```
...
print(manager_version_probe("ghcup"))
```
