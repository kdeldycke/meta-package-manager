# {octicon}`package` Julia juliaup

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("juliaup"))
```
...
print(manager_augments("juliaup"))
```
...
print(manager_operations("juliaup"))
```
...
print(manager_selection("juliaup"))
```
...
print(manager_cooldown("juliaup"))
```
...
print(manager_version_probe("juliaup"))
```
...
print(manager_upstream("juliaup"))
```
...
print(manager_changelog("juliaup"))
```
