# {octicon}`package` kubectl krew

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("krew"))
```
...
print(manager_version_probe("krew"))
```
