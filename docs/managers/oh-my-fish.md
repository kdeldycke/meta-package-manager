# {octicon}`package` Fish Oh My Fish

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("oh-my-fish"))
```
...
print(manager_augments("oh-my-fish"))
```
...
print(manager_rosetta("oh-my-fish"))
```
...
print(manager_operations("oh-my-fish"))
```
...
print(manager_selection("oh-my-fish"))
```
...
print(manager_recipes("oh-my-fish"))
```
...
print(manager_cooldown("oh-my-fish"))
```
...
print(manager_version_probe("oh-my-fish"))
```
...
print(manager_upstream("oh-my-fish"))
```
...
print(manager_changelog("oh-my-fish"))
```
