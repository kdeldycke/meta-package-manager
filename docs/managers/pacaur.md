# {octicon}`package` Arch Linux pacaur

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("pacaur"))
```
...
print(manager_operations("pacaur"))
```
...
print(manager_version_probe("pacaur"))
```
...
print(manager_changelog("pacaur"))
```
