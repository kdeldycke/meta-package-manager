# {octicon}`package` Rust rustup

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("rustup"))
```
...
print(manager_operations("rustup"))
```
...
print(manager_selection("rustup"))
```
...
print(manager_version_probe("rustup"))
```
...
print(manager_changelog("rustup"))
```
