...
print(manager_augments("sheldon"))
```
...
print(manager_operations("sheldon"))
```
...
print(manager_selection("sheldon"))
```
...
print(manager_cooldown("sheldon"))
```
...
print(manager_changelog("sheldon"))
```
