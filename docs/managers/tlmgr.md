# {octicon}`package` TeX Live Manager

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("tlmgr"))
```
...
print(manager_version_probe("tlmgr"))
```
