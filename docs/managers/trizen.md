# {octicon}`package` Arch Linux trizen

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("trizen"))
```
...
print(manager_operations("trizen"))
```
...
print(manager_selection("trizen"))
```
...
print(manager_version_probe("trizen"))
```
...
print(manager_changelog("trizen"))
```
