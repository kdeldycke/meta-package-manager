...
print(manager_augments("vagrant"))
```
...
print(manager_operations("vagrant"))
```
...
print(manager_selection("vagrant"))
```
...
print(manager_cooldown("vagrant"))
```
...
print(manager_version_probe("vagrant"))
```
...
print(manager_changelog("vagrant"))
```
