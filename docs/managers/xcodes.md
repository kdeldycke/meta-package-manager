# {octicon}`package` Xcode xcodes

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("xcodes"))
```
...
print(manager_operations("xcodes"))
```
...
print(manager_selection("xcodes"))
```
...
print(manager_version_probe("xcodes"))
```
...
print(manager_changelog("xcodes"))
```
