# {octicon}`package` openSUSE Zypper

```{python:render}
from meta_package_manager._docs import manager_intro

print(manager_intro("zypper"))
```
...
print(manager_operations("zypper"))
```
...
print(manager_version_probe("zypper"))
```
...
print(manager_changelog("zypper"))
```
