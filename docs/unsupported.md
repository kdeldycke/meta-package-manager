...
| :--- | :---: | :--- | :--- |
| [`antibody`](https://github.com/getantibody/antibody) | ☠️ | Zsh plugin manager | Archived on 2022-05-27, superseded by [`antidote`](https://github.com/mattmc3/antidote). |
...
| [`dein`](https://github.com/Shougo/dein.vim) | ☠️ | Vim and Neovim plugin manager | Development stopped, superseded by [dpp.vim](https://github.com/Shougo/dpp.vim), last commit on 2025-09-13. Pure Vimscript, so it also exposes neither a binary to run nor a version to report. |
...
| [`neobundle`](https://github.com/Shougo/neobundle.vim) | ☠️ | Vim plugin manager | No commit since 2018-07-26, superseded by `dein`, itself superseded by dpp.vim. |
...
| [`packer-nvim`](https://github.com/wbthomason/packer.nvim) | ☠️ | Neovim plugin manager | README has declared it unmaintained since August 2023, pointing at [lazy.nvim](https://github.com/folke/lazy.nvim) and [pckr.nvim](https://github.com/lewis6991/pckr.nvim). |
