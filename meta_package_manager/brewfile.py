...
def format_header(
    ...
    # Read off {data}`BUNDLE_ENTRY_TYPES` instead of spelled out a second time:
    # the header is the one place this list reaches the user, and a hand-kept
    # copy of it drifts the moment a manager gains a mapping.
    entry_types = ", ".join(et for et in BUNDLE_ENTRY_TYPES if et != "tap")
    return (
