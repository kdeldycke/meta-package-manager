...
class PNPM(PackageManager):
    ...
    documentation_url = "https://pnpm.io/pnpm-cli"
    ...
    requirement = ">=11.0.0"
    """[11.0.0](https://github.com/pnpm/pnpm/releases/tag/v11.0.0) is the first
    ...
    cooldown (see {attr}`cooldown_env_var`), so a single floor covers every
    ...
    def outdated(self) -> Iterator[Package]:
        ...
        not raise (see {meth}`meta_package_manager.execution.CLIExecutor.run`).
