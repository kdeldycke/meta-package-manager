...
def test_manager_count():
    ...
    # Thirty-five extra beyond the built-in classes: the bundled config-defined
    # managers (apt-cyg, bin, cargo, cave, choco, chromebrew, cpan, fink,
    # gcloud, gh-ext, haxelib, juliaup, krew, macports, micro, opam, opkg,
    # pamac, pkg-tools, pkgin, pyenv, rustup, slapt-get, soar, sorcery,
