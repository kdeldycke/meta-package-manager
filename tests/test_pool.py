...
def test_manager_count():
    ...
    # Forty-six extra beyond the built-in classes: the bundled config-defined
    ...
    # macports, micro, ollama, opam, opkg, pamac, pkg-tools, pkgin, pkgm, pyenv,
    # raco, rustup, slapt-get, soar, sorcery, steamcmd, stew, swupd, tlmgr,
