...
def test_manager_count():
    ...
    # Fifty-one extra beyond the built-in classes: the bundled config-defined
    # managers (apt-cyg, basalt, bob, bpkg, bun, cargo, cave, choco, chromebrew, claude-code-plugins,
    # clib, cpan, elan, emacs, fink, gcloud, getnf, gh-ext, haxelib, jpm, juliaup, krew,
    # macports, micro, ollama, opam, opkg, pamac, pkg-tools, pipxu, pkgin, pkgm, platformio-core, pyenv,
