...
def test_manager_count():
    ...
    # Fifty-three extra beyond the built-in classes: the bundled config-defined
    ...
    # macports, micro, ollama, opam, opkg, pamac, pi, pkg-tools, pipxu, pkgin, pkgm, platformio-core, pyenv,
