...
def test_manager_count():
    ...
    assert len(manager_classes) == 75
    # Thirty-seven extra beyond the built-in classes: the bundled config-defined
    # managers (apt-cyg, bun, cargo, cave, choco, chromebrew, cpan, fink,
