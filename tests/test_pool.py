...
def test_manager_count():
    ...
    # Forty-five extra beyond the built-in classes: the bundled config-defined
    # managers (apt-cyg, basalt, bob, bpkg, bun, cargo, cave, choco, chromebrew,
    # clib, cpan, elan, fink, gcloud, getnf, gh-ext, haxelib, jpm, juliaup, krew,
    # macports, micro, ollama, opam, opkg, pamac, pkg-tools, pkgin, pyenv, raco,
    # rustup, slapt-get, soar, sorcery, steamcmd, stew, swupd, tlmgr, topgrade,
    # urpmi, vscode, vscodium, xcodes, yazi, zerobrew), shipped as package data
