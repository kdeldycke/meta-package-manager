...
def test_manager_count():
    ...
    assert len(manager_classes) == 66
    # Thirty-four extra beyond the built-in classes: the bundled config-defined
    # managers (apt-cyg, bin, cargo, cave, choco, chromebrew, cpan, fink,
    # gcloud, gh-ext, haxelib, juliaup, krew, macports, opam, opkg, pamac,
    # pkg-tools, pkgin, pyenv, rustup, slapt-get, soar, sorcery, steamcmd, stew,
    # swupd, tlmgr, topgrade, urpmi, vscode, vscodium, xcodes, zerobrew),
