...
def test_manager_count():
    ...
    # Twenty-nine extra beyond the built-in classes: the bundled config-defined
    # managers (apt-cyg, bin, cargo, cave, choco, chromebrew, cpan, fink, gh-ext,
    # haxelib, krew, macports, opam, opkg, pamac, pkg-tools, pkgin, slapt-get, soar, sorcery,
    # steamcmd, stew, swupd, tlmgr, topgrade, urpmi, vscode, vscodium,
    # zerobrew), shipped as package data and loaded into the pool at
    # construction.
    assert len(pool) == 93
